...
export default function Pricing() {
  ...
  React.useEffect(() => {
    ...
    if (el) el.setAttribute('content', 'Simple, transparent pricing for self-managed landlords. Start free with 1 property. Scale to unlimited. Tenants are always free.');
  }, []);
  return (
